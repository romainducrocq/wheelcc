...
void string_to_literal(char* str_string, std::vector<int8_t>& string_literal);
int32_t string_to_char_ascii(char* str_char);
...
int string_to_dbl(ErrorsContext* ctx, const char* str_dbl, size_t line, double* value);
