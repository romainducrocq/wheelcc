...
static std::string get_what_message(ERROR_MESSAGE message) {
    switch (message) {
        case ERROR_MESSAGE::unhandled_runtime_error:
        ...
        // Util
        case ERROR_MESSAGE::failed_to_read_output_file:
            return "cannot read input file %s";
        case ERROR_MESSAGE::failed_to_write_to_output_file:
            return "cannot write output file %s";
        case ERROR_MESSAGE::failed_to_interpret_string_to_integer:
            return "cannot interpret string %s to an integer value";
        case ERROR_MESSAGE::failed_to_interpret_string_to_unsigned_integer:
            return "cannot interpret string %s to an unsigned integer value";
        case ERROR_MESSAGE::failed_to_interpret_string_to_float:
        ...
        case ERROR_MESSAGE::unexpected_binary_operator:
        ...
        case ERROR_MESSAGE::unexpected_abstract_declarator:
        ...
        case ERROR_MESSAGE::unexpected_pointer_unary_factor:
        ...
        case ERROR_MESSAGE::unexpected_primary_expression_factor:
        ...
        case ERROR_MESSAGE::unexpected_expression:
            return "found token %s, but expected " + em(get_token_kind_hr(TOKEN_KIND::binop_addition)) + ", "
                   + em(get_token_kind_hr(TOKEN_KIND::unop_negation)) + ", "
                   + em(get_token_kind_hr(TOKEN_KIND::binop_multiplication)) + ", "
                   + em(get_token_kind_hr(TOKEN_KIND::binop_division)) + ", "
        ...
        case ERROR_MESSAGE::function_declared_in_for_initial:
            return "function %s declared in " + em("for") + " loop initial declaration";
        case ERROR_MESSAGE::unexpected_type_specifier:
            return "found token %s, but expected " + em(get_token_kind_hr(TOKEN_KIND::identifier)) + ", "
                   ...
                   + em(get_token_kind_hr(TOKEN_KIND::parenthesis_open)) + " or "
                   + em(get_token_kind_hr(TOKEN_KIND::brackets_open)) + " next";
        case ERROR_MESSAGE::unexpected_type_specifier_list:
            return "found tokens %s, but expected valid list of unique type specifiers next";
        case ERROR_MESSAGE::unexpected_storage_class:
        ...
        case ERROR_MESSAGE::type_derivation_on_function_declaration:
            return "cannot apply further type derivation to function declaration";
        case ERROR_MESSAGE::unexpected_simple_declarator:
            return "found token %s, but expected " + em(get_token_kind_hr(TOKEN_KIND::identifier)) + " or "
                   + em(get_token_kind_hr(TOKEN_KIND::parenthesis_open)) + " next";
        case ERROR_MESSAGE::unexpected_parameter_list:
        ...
        case ERROR_MESSAGE::member_declared_with_non_automatic_storage:
            return "structure type declared with member %s with %s storage class";
        case ERROR_MESSAGE::member_declared_as_function:
        ...
        case ERROR_MESSAGE::goto_with_undefined_target_label:
