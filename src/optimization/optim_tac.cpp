    ...
    switch (constant->type()) {
        case AST_T::CConstInt_t: {
            switch (frontend->symbol_table[node->name]->type_t->type()) {
                case AST_T::Char_t:
                case AST_T::SChar_t: {
                    TChar value = static_cast<TChar>(static_cast<CConstInt*>(constant)->value);
                    fold_constant = std::make_shared<CConstChar>(std::move(value));
                    break;
                }
                case AST_T::UChar_t: {
                    TUChar value = static_cast<TUChar>(static_cast<CConstInt*>(constant)->value);
        ...
        case AST_T::CConstLong_t: {
            switch (frontend->symbol_table[node->name]->type_t->type()) {
                case AST_T::Char_t:
                case AST_T::SChar_t: {
                    TChar value = static_cast<TChar>(static_cast<CConstLong*>(constant)->value);
                    fold_constant = std::make_shared<CConstChar>(std::move(value));
                    break;
                }
                case AST_T::Int_t: {
                ...
                case AST_T::UChar_t: {
                    TUChar value = static_cast<TUChar>(static_cast<CConstLong*>(constant)->value);
                    fold_constant = std::make_shared<CConstUChar>(std::move(value));
                    break;
                }
                case AST_T::UInt_t: {
        ...
        case AST_T::CConstUInt_t: {
            switch (frontend->symbol_table[node->name]->type_t->type()) {
                case AST_T::Char_t:
                case AST_T::SChar_t: {
                    TChar value = static_cast<TChar>(static_cast<CConstUInt*>(constant)->value);
                    fold_constant = std::make_shared<CConstChar>(std::move(value));
                    break;
                }
                case AST_T::UChar_t: {
                    TUChar value = static_cast<TUChar>(static_cast<CConstUInt*>(constant)->value);
                    fold_constant = std::make_shared<CConstUChar>(std::move(value));
                    break;
                }
                default:
        ...
        case AST_T::CConstULong_t: {
            switch (frontend->symbol_table[node->name]->type_t->type()) {
                case AST_T::Char_t:
                case AST_T::SChar_t: {
                    TChar value = static_cast<TChar>(static_cast<CConstULong*>(constant)->value);
                    fold_constant = std::make_shared<CConstChar>(std::move(value));
                    break;
                }
                case AST_T::Int_t: {
                ...
                case AST_T::UChar_t: {
                    TUChar value = static_cast<TUChar>(static_cast<CConstULong*>(constant)->value);
                    fold_constant = std::make_shared<CConstUChar>(std::move(value));
                    break;
                }
                case AST_T::UInt_t: {
...
static std::shared_ptr<TacConstant> fold_constants_unary_constant_value(TacUnaryOp* node, CConst* constant) {
    ...
    switch (constant->type()) {
        case AST_T::CConstInt_t: {
            switch (node->type()) {
                case AST_T::TacComplement_t: {
                    TInt value = ~static_cast<CConstInt*>(constant)->value;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                ...
                case AST_T::TacNot_t: {
                    TInt value = !static_cast<CConstInt*>(constant)->value ? 1 : 0;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                default:
        ...
        case AST_T::CConstLong_t: {
            switch (node->type()) {
                case AST_T::TacComplement_t: {
                    TLong value = ~static_cast<CConstLong*>(constant)->value;
                    fold_constant = std::make_shared<CConstLong>(std::move(value));
                    break;
                }
                case AST_T::TacNegate_t: {
                ...
                case AST_T::TacNot_t: {
                    TInt value = !static_cast<CConstLong*>(constant)->value ? 1 : 0;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                default:
        ...
        case AST_T::CConstDouble_t: {
            switch (node->type()) {
                case AST_T::TacNegate_t: {
                    TDouble value = -static_cast<CConstDouble*>(constant)->value;
                    fold_constant = std::make_shared<CConstDouble>(std::move(value));
                    break;
                }
                case AST_T::TacNot_t: {
                    TInt value = !static_cast<CConstDouble*>(constant)->value ? 1 : 0;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                default:
        ...
        case AST_T::CConstUInt_t: {
            switch (node->type()) {
                case AST_T::TacComplement_t: {
                    TUInt value = ~static_cast<CConstUInt*>(constant)->value;
                    fold_constant = std::make_shared<CConstUInt>(std::move(value));
                    break;
                }
                case AST_T::TacNegate_t: {
                ...
                case AST_T::TacNot_t: {
                    TInt value = !static_cast<CConstUInt*>(constant)->value ? 1 : 0;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                default:
        ...
        case AST_T::CConstULong_t: {
            switch (node->type()) {
                case AST_T::TacComplement_t: {
                    TULong value = ~static_cast<CConstULong*>(constant)->value;
                    fold_constant = std::make_shared<CConstULong>(std::move(value));
                    break;
                }
                case AST_T::TacNegate_t: {
                ...
                case AST_T::TacNot_t: {
                    TInt value = !static_cast<CConstULong*>(constant)->value ? 1 : 0;
                    fold_constant = std::make_shared<CConstInt>(std::move(value));
                    break;
                }
                default:
