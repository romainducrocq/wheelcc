...
ast = [
    ...
    ["CAbstractArray", [(TULong, "size")], ["abstract_declarator"]],
    ["CAbstractBase", [], []],
    ["CParam", [], ["declarator", "param_type"]],
    ["CDeclarator", [], []],
    ["CIdent", [(TIdentifier, "name")], []],
    ["CPointerDeclarator", [], ["declarator"]],
    ["CArrayDeclarator", [(TULong, "size")], ["declarator"]],
    ...
    ["TacCopyToOffset", [(TIdentifier, "dst_name"), (TULong, "offset")], ["src"]],
    ...
    ["AsmMemory", [(TULong, "value"), (Bool, "is_negative")], ["reg"]],
