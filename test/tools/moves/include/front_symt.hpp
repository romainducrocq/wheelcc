...
#define GET_STRUCT_TYPEDEF_MEMBER(X, Y) ctx->frontend->struct_typedef_table[X]->members[ctx->frontend->struct_typedef_table[X]->member_names[Y]]
#define GET_STRUCT_TYPEDEF_BACK(X) ctx->frontend->struct_typedef_table[X]->members[ctx->frontend->struct_typedef_table[X]->member_names.back()]
