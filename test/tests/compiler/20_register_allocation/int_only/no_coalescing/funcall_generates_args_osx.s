...
LBB0_4:
	...
	.p2align	3, 0x0                          ## -- Begin function use_dbls
LCPI1_0:
...
## %bb.0:
	...
	movsd	LCPI1_0(%rip), %xmm1            ## xmm1 = [1.1E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB1_1
	jp	LBB1_1
	jmp	LBB1_2
...
LBB1_2:
	...
	movsd	LCPI1_1(%rip), %xmm1            ## xmm1 = [1.2E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB1_3
	jp	LBB1_3
	jmp	LBB1_4
...
L_.str:                                 ## @.str
	.asciz	"Expected a to be 11 but found %d\n"

L_.str.1:                               ## @.str.1
	.asciz	"Expected b to be 12 but found %d\n"

L_.str.2:                               ## @.str.2
	.asciz	"Expected a to be 11.0 but found %f\n"

L_.str.3:                               ## @.str.3
	.asciz	"Expected b to be 12.0 but found %f\n"
