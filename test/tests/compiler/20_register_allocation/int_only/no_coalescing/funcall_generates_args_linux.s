	...
	.align 8
.LC0:
	.string	"Expected a to be 11 but found %d\n"
	.align 8
.LC1:
	.string	"Expected b to be 12 but found %d\n"
	.text
	.globl	f
	.type	f, @function
f:
...
.LFE0:
	...
	.align 8
.LC3:
	.string	"Expected a to be 11.0 but found %f\n"
	.align 8
.LC5:
	.string	"Expected b to be 12.0 but found %f\n"
	.text
	.globl	use_dbls
	.type	use_dbls, @function
use_dbls:
.LFB1:
	.cfi_startproc
	pushq	%rbp
