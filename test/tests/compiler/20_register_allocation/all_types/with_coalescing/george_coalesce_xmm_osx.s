...
## %bb.0:
	...
	movsd	LCPI0_1(%rip), %xmm1            ## xmm1 = [2.0E+0,0.0E+0]
	movsd	LCPI0_2(%rip), %xmm2            ## xmm2 = [3.0E+0,0.0E+0]
	movsd	LCPI0_3(%rip), %xmm3            ## xmm3 = [4.0E+0,0.0E+0]
	movsd	LCPI0_4(%rip), %xmm4            ## xmm4 = [5.0E+0,0.0E+0]
	movsd	LCPI0_5(%rip), %xmm5            ## xmm5 = [6.0E+0,0.0E+0]
	movsd	LCPI0_6(%rip), %xmm6            ## xmm6 = [7.0E+0,0.0E+0]
	movsd	LCPI0_7(%rip), %xmm7            ## xmm7 = [8.0E+0,0.0E+0]
	callq	_dbl_target
	cvttsd2si	%xmm0, %eax
	popq	%rbp
	retq
