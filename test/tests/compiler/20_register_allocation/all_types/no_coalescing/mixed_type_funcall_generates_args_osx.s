...
LBB0_2:
	...
	movsd	LCPI0_0(%rip), %xmm1            ## xmm1 = [-4.0E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB0_3
	jp	LBB0_3
	jmp	LBB0_4
...
LBB0_6:
	...
	movsd	LCPI0_1(%rip), %xmm1            ## xmm1 = [2.02E+2,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB0_7
	jp	LBB0_7
	jmp	LBB0_8
...
L_.str:                                 ## @.str
	.asciz	"Expected s1.l to be -50, found %ld\n"

L_.str.1:                               ## @.str.1
	.asciz	"Expected s1.d to be -40.0, found %f\n"

L_.str.2:                               ## @.str.2
	.asciz	"Expected a to have value 101, actual value was %ld\n"

L_.str.3:                               ## @.str.3
	.asciz	"Expected b to have value 202.0, actual value was %f\n"
