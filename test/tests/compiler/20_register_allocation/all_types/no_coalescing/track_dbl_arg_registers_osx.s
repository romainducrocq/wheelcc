...
## %bb.0:
	...
	movsd	LCPI0_0(%rip), %xmm1            ## xmm1 = [1.2E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB0_1
	jp	LBB0_1
	jmp	LBB0_2
...
LBB0_2:
	...
	movsd	LCPI0_1(%rip), %xmm1            ## xmm1 = [1.3E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB0_3
	jp	LBB0_3
	jmp	LBB0_4
...
LBB0_4:
	...
	movsd	LCPI0_2(%rip), %xmm1            ## xmm1 = [1.4E+1,0.0E+0]
	ucomisd	%xmm1, %xmm0
	jne	LBB0_5
	jp	LBB0_5
	jmp	LBB0_6
...
L_.str:                                 ## @.str
	.asciz	"Expected a to be 12, found %f\n"

L_.str.1:                               ## @.str.1
	.asciz	"Expected b to be 13, found %f\n"

L_.str.2:                               ## @.str.2
	.asciz	"Expected c to be 14, found %f\n"
